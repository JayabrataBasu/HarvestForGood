...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <div className="md:w-1/3">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-accent p-4 rounded-lg shadow-md z-10">
                <span className="text-primary-dark font-bold">Our Vision</span>
              </div>
            </div>
          </div>
              ...
              <div className="flex gap-6 feature-card bg-white p-6 rounded-xl shadow-card hover:shadow-card-hover transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    at all sizes. Learn about economic models that support both
      ...
      <section className="mb-20 pattern-bg py-16 rounded-2xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-gradient">
          Meet Our Team
        </h2>
        <p className="text-center text-gray-600 mb-16 max-w-3xl mx-auto">
          We are a team of researchers at the Schulich School of Business, York
          University. We are passionate about studying sustainable
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-4">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="team-card bg-white rounded-xl overflow-hidden"
            >
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient p-10 rounded-xl mx-auto max-w-4xl text-white">
            ...
            <p className="mb-8 text-white/90 max-w-2xl mx-auto">
              Contribute to our growing community of researchers, practitioners,
              and policymakers working toward sustainable agricultural systems.
            </p>
            <Link
              href="/contact"
