...
const samplePapers: ResearchPaper[] = [
  ...
  },
  {
    ...
    abstract:
      "Transfer learning aims to improve the performance of target learning task by leveraging knowledge from source tasks. This survey is focused on categorizing and reviewing the current progress on transfer learning for classification, regression, and clustering problems.",
...
const SearchPage: React.FC = () => {
  ...
  const [filteredPapers, setFilteredPapers] =
    useState<ResearchPaper[]>(samplePapers);
  ...
  useEffect(() => {
    ...
    setFilteredPapers(uniqueResults);
  }, [searchQuery, papers]);
